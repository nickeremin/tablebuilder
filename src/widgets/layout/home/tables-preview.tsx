          ...
          <Link
            ...
            className={cn(
              buttonVariants({
                ...
                variant: "outline",
                className:
                  "relative z-0 w-full max-w-[280px] whitespace-nowrap border-transparent bg-background bg-clip-padding transition-colors hover:bg-transparent hover:text-primary-foreground",
              })
            )}
          >
          ...
          <Link
            ...
            className={cn(
              buttonVariants({
                ...
                variant: "outline",
                className:
                  "transition-color relative z-0 w-full whitespace-nowrap border-transparent bg-background bg-clip-padding hover:bg-transparent hover:text-primary-foreground",
              })
            )}
          >
            Ознакомиться с Продуктом
...
export { TablesPreview, HomePreview }
